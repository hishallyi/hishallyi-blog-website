...
> 本文为[【黑马程序员Redis入门到实战教程】](https://www.bilibili.com/video/BV1cr4y1671t/)配套资料编辑修改，只做个人学习使用，不做商业传播

大多数企业都是基于Linux服务器来部署项目，而且Redis官方也没有提供Windows版本的安装包。因此此教程基于Linux系统来安装Redis.此处选择的Linux版本为CentOS 7.
...
> ```
>
> 参考博客https://blog.csdn.net/jiangcheng2016/article/details/121365732
>
> 分别运行下面两个命令：
>
> ```shell
...
> 安装完成后，再重新执行。
>
> **注意：如果还是不成功，将已经解压的`redis`安装包删除，重新解压，重新`make install`**（重点！！！）
